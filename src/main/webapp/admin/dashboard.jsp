      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="post" aria-expanded="false">
                <span>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="card-body">
                  <form action="change-password" method="post" >
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="current-password" name="current-password" value="<%= session.getAttribute("password") %>"  disabled/>
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by <a href="https://github.com/WinHtooNaing" target="_blank" class="pe-1 text-primary text-decoration-underline">Win Htoo Naing</a></p>
        </div>
      </div>
    </div>
